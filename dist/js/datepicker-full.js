(function () {
  ...
  function findElementInEventPath(ev, selector) {
    const criteria =
      typeof selector === "function" ? selector : (el) => el.matches(selector);
  ...
  const defaultOptions = {
    ...
    minDate: null,
    nextArrow:
      "<img src='https://i.ibb.co/fnFtjZV/leftarrow.png' style='width: 24px; height: 24px; transform: rotate(180deg)'>",
    orientation: "auto",
    pickLevel: 0,
    prevArrow:
      "<img src='https://i.ibb.co/fnFtjZV/leftarrow.png' style='width: 24px; height: 24px; '>",
    showDaysOfWeek: true,
    showOnClick: true,
    showOnFocus: true,
    startView: 0,
  ...
  class Picker {
    ...
    place() {
      ...
      classList.add(
        `datepicker-orient-${orientY}`,
        `datepicker-orient-${orientX}`
      );
